  ...
  return (
    <article id="skills" className="flex flex-col items-center w-full py-10">
      ...
      <div className="relative flex flex-col items-center w-full gap-2.5 box-border md:flex-row md:justify-center md:gap-7.5 md:p-10">
        <section className="flex flex-col items-center rounded-[100px_0_100px_0] m-3 p-5 w-4/5 bg-white border-2 border-black shadow-lg transition-all duration-200 ease-in-out md:w-[400px] md:h-[400px] md:p-0 md:pr-2.5 md:pb-10">
          ...
          <ul className="flex flex-wrap justify-center gap-2.5 pt-5 md:gap-5 md:pt-7.5">
            {frontSkills.map((skill, index) => (
              <li key={index} className="w-[calc((100%-40px)/2)] mb-5 md:w-[calc((100%-60px)/3)] flex flex-col items-center">
